                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="text-lg leading-7 font-semibold text-center block" style="width: 100%">
                                    <a target="_blank" href="https://github.com/CGIS-2023/proyecto-cgis-2023-paulopamu" class="underline text-gray-900 dark:text-white">Paula López</a>
                                </div>
                            </div>

                            <div class="">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Ing. de la Salud - Codificación y Gestión de la Información Sanitaria 2023
                                </div>
                            </div>
                        </div>
                    </div>
